...
//Address
$query= "SELECT *  FROM addresses, borrower_addresses, borrowers WHERE borrowers.borrower_id = borrower_addresses.user_id AND addresses.address_id = borrower_addresses.address_id and borrowers.name = '". $username."'";
